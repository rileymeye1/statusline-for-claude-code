...
<!-- PRs should reference an approved issue (see CONTRIBUTING.md). -->
Closes #
...
- [ ] Tested on: <!-- e.g. macOS / bash, Windows / PowerShell -->
- [ ] No new required dependencies
- [ ] Updated `README.md` / `TESTING.md` if behavior or config changed
